qui {
	...
	if 1 { //Log, Settings, Macros, Workdirectory, Data
		...
		global url "https://raw.githubusercontent.com/Kiyoiiiii/hw1/main/the%20simulation.do" //you all have your own URLs, this is one of your peers just for demo purposes
